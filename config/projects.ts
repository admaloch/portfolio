...
export const Projects: ProjectInterface[] = [
  {
    ...
    techStack: ["Python", "FastAPI", "PostgreSQL", "Supabase"],
  ...
  },
  {
    ...
    techStack: ["Javascript", "HTML 5", "CSS 3", "Bootstrap"],
  ...
  },
  {
    ...
    shortDescription: "Custom movie search app built with MERN and OMDb API",
  ...
  },
  {
    ...
    techStack: ["Firebase", "Google Cloud"],
    startDate: new Date("2024-01-01"),
    endDate: new Date("2025-01-01"),
  ...
  },
  {
    ...
    techStack: ["React", "MongoDB", "Express.js", "Node.js", "Redux"],
    startDate: new Date("2023-01-01"),
    endDate: new Date("2024-01-01"),
  ...
  },
  {
    ...
    shortDescription: "Movie search app built using OMDB API",
  ...
  },
  {
    ...
    shortDescription: "Image Based QR Code Generator",
  ...
  },
  {
    ...
    type: "Professional",
    category: ["Web Dev", "Frontend"],
    shortDescription: "Image slider with dynamic QR code generation",
  ...
  },
  {
    ...
    websiteLink:
      "https://www.floridamemory.com/learn/research-tools/guides/black-history-collections/",
    techStack: ["Javascript", "HTML 5", "CSS 3"],
    startDate: new Date("2023-01-01"),
    endDate: new Date("2024-01-01"),
